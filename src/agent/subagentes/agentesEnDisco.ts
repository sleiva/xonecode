...
const EJECUCION_EN_LA_MAQUINA = [
  ...
  "Los de `xone-hotswap` son `xone-reiniciar-android` (déjalo en estado conocido: es lo",
  "primero que hay que probar si el canal no contesta), `xone-desplegar-android`,",
  "`xone-hotswap`, `xone-log-android` (las excepciones del aparato, que es donde está el",
  "porqué cuando algo no se pinta) y `xone-arrancar-ios`;",
  ...
  "- No escribas ficheros sueltos en la raíz del proyecto: es la app del usuario. Lo que quieras",
  "  ENSEÑAR va a `$XONECODE_ARTEFACTOS`, y los scripts ya lo hacen por ti.",
