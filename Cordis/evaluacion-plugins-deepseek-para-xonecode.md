...
|---|---|---|
| [lsp + lsp-stdio + tool-lsp](/Users/projects/harnees/deepseek-harness/packages/lsp/tool-lsp/README.md) | Navegación precisa cuando existe un servidor de lenguaje. | **Actualización 18-09-2026:** xonecode ya implementó el índice semántico y la tool `xone_navegacion` por nombre. Falta el adaptador del protocolo LSP con rangos si se quiere navegación desde editores o DSH. Véase el [estado y diseño específico](./navegacion-xone-lsp-y-referencias.md). |
